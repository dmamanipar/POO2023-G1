...
public class PreguntasDao implements PreguntasDaoI{
        ...
        do {
            switch (opcion) {
                case "C" -> {
                    ...
                    System.out.println("Ingrese IdBp: ");
                    tox.setIdBancoPreguntas(cs.nextInt());
                    System.out.println("Ingrese IdAreaperiodo:");
                ...
                case "U" -> {
                    PreguntasTO tox;
                    System.out.println("Ingres IdPregunta:");                    
                    int id_pregunta=cs.nextInt();
                    tox=po.buscarEntidad(id_pregunta);  
                    
                    System.out.println("Ingres nuevo IdBp:");
                    tox.setIdBancoPreguntas(cs.nextInt());
                    System.out.println("Ingres nuevo Area Periodo: ");
                    tox.setIdAreaPeriodo(cs.nextInt());
                    System.out.println("Ingres Nuevo resultado: ");
                    tox.setResultado(cs.next());
                ...
                case "D" -> {
                    try {
                        System.out.println("Ingrese id_pregunta del Registro que desea eliminar:");
    ...
    public void listarPregunta(List<PreguntasTO> lista) {
        System.out.println("IdPregunta\t\tIdBancoPreguntas\t\tIdAreaPeriodo\t\tResultado\t\tNumero");
        for (PreguntasTO p : lista) {
            System.out.println(p.getIdPregunta() + "\t\t\t" + p.getIdBancoPreguntas() + "\t\t\t"
                    + p.getIdAreaPeriodo() + "\t\t\t" + p.getResultado() + "\t\t\t" + p.getNumero() );
        }
    }
